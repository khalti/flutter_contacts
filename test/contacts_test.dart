...
void main() {
  ...
  group(
    'ContactsService.getContactsForEmail',
    () {
      /// Just tests whether the plugin call is fired.
      test(
        'returns contacts when email is supplied',
        () async {
  ...
  test(
    'should get low-res avatar for contact identifiers',
    () async {
      final contact = Contact(givenName: 'givenName');
  ...
  test(
    'should provide initials for contact',
    () {
      final Contact contact1 =
          Contact(givenName: 'givenName', familyName: 'familyName');
      final Contact contact2 = Contact(givenName: 'givenName');
      final Contact contact3 = Contact(familyName: 'familyName');
  ...
  test(
    'should show contacts are equal',
    () {
  ...
  test(
    'should produce a valid merged contact',
    () {
      final Contact contact1 = Contact(
        givenName: 'givenName',
        familyName: 'familyName',
      ...
      final Contact mergedContact = Contact(
        givenName: 'givenName',
        familyName: 'familyName',
        emails: [
          Item(label: 'Home', value: 'home@example.com'),
  ...
  test(
    'should provide a valid merged contact, with no extra info',
    () {
      final Contact contact1 = Contact(familyName: 'familyName');
      final Contact contact2 = Contact();
  ...
  test(
    'should provide a map of the contact',
    () {
